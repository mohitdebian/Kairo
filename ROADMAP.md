...
- [x] Basic Tab Management (WebContentsView)
- [x] Address Bar & Navigation
- [x] Sidebar layout and glassmorphic UI
- [x] Context Menus (Wayland/Linux compatible)
- [ ] History & Bookmarks database
- [ ] Downloads Manager
- [ ] Basic Settings UI
...
- [ ] Local Page Summarization (via local LLMs)
...
- [ ] End-to-End Encrypted Sync (Tabs, Spaces, History, Settings)
- [ ] Shared Spaces (Collaborate on research with others)
...
- [ ] Kairo Native Plugins (React-based plugins for the Sidebar)
- [ ] Theming Engine (Shareable themes)
