  ...
  return (
    <>
      ...
      {isOpen && typeof document !== 'undefined' && ReactDOM.createPortal(
        <div id="site-settings-popover" className="fixed z-[9999]" style={{
          top: (buttonRef.current?.getBoundingClientRect().bottom || 0) + 10,
          ...
          >
            ...
            <div className="p-2 border-t border-white/5 bg-black/20 flex flex-col gap-1">
              ...
              >
                ...
                {cleared ? 'Cleared & Reloading...' : isClearing ? 'Clearing...' : 'Clear cookies and site data'}
              </button>
