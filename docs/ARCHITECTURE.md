...
Unlike standard web apps, a browser has to juggle a highly privileged backend (Main Process) with a sandboxed frontend (Renderer Process) while rendering *untrusted* third-party websites in a secure, isolated manner.
